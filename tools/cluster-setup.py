...
run_command(
    ...
    r"helm install vault charts/vault/ --values charts/values.yaml --wait"
)
...
run_command(
    ...
    r"helm install mongo charts/mongo/ --namespace=vault --values charts/values.yaml --wait"
)
...
run_command(
    "starting app",
    r"helm install app charts/app/ --namespace=vault --values charts/values.yaml --wait"
)
